...
class GenerateXLSXReport(models.Model):
    ...
    def generate_xlsx_report(self, workbook, data, line):
        ...
        format3 = workbook.add_format({'font_size': '12', 'align': 'center', 'bold': True, 'font_color': '#0000FF'})
        sheet = workbook.add_worksheet('Performa Invoice')
        ...
        format2 = workbook.add_format({'font_size': '12', 'align': 'vcenter', 'border':True})
        row = 1
        ...
        for line in msa_obj.msa_simulation_ids:
            ...
            site_billing_id = self.env['site.billing.info'].search([('site_id','=',line.site_id.id),('msa_id','=',line.msa_id.id),('billable','=',True)],limit=1)
            ...
            if site_billing_id.id:
                ...
                sheet.write(row, 27, line.opex, format2)
