...
class GenerateXLSXReport(models.Model):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        for line in move_line_ids.filtered(lambda x: x.location_id.id in data['location_ids'] or x.location_dest_id.id in data['location_ids']):
        #for line in move_line_ids:
            ...
            if project_id.id:   
                sheet.write(row, 0, project_id.name, format2)
