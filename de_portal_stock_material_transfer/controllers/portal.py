    ...
    def create_stock_material(self, **kw):
        ...
        for stock in stock_transfer_lista:
            ...
            if line_product_count > 1:
                ...
                #if line_product.qty_available <= 0:
                #    raise UserError('The Product '+str(line_product.name)+' '+ 'stock equal to 0.')
                line_vals = {
        ...
        for stockline in stock_transfer_return_listb:
            ...
            if return_line_count > 1:
                ...
                #if return_line_product.qty_available <= 0:
                #    raise UserError('The Product '+str(return_line_product.name)+' '+ 'stock equal to 0.')
                return_line_vals = {
                    'stock_transfer_order_id': record.id,
